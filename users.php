...
<div class="container-fluid">
	...
	<div class="row">
	<div class="col-lg-12">
			<button class="btn btn-primary float-right btn-sm" id="new_user"><i class="fa fa-plus"></i> Thêm người dùng</button>
	</div>
	</div>
	<br>
	<div class="col-lg-12">
		<div class="card ">
			<div class="card-header"><b>Danh sách đăng nhập</b></div>
			<div class="card-body">
...
$('.edit_user').click(function(){
	uni_modal('Chỉnh sửa người dùng','manage_user.php?id='+$(this).attr('data-id'))
})
