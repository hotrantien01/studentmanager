...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header"><b>Bản ghi điểm danh</b></div>
			<div class="card-body">
				<form id="manage-attendance">
					<input type="hidden" name="id" value="">
					<div class="row justify-content-center">
						<label for="" class="mt-2">Lớp học phần</label>
						<div class="col-sm-4">
						...
						<div class="col-sm-2">
							<button class="btn  btn-primary" type="button" id="filter"> Tìm kiếm</button>
						</div>
					</div>
					<hr>
					<div class="row">
						<div class="col-md-12" id='att-list'>
							<center><b><h4><i>Vui lòng chọn lớp học đầu tiên.</i></h4></b></center>
						</div>
						<div class="col-md-12"  style="display: none" id="submit-btn-field">
							<center>
								<button class="btn btn-primary btn-sm col-sm-3" type="button" id="edit_att"><i class="fa fa-edit" data-id=''></i> Sửa</button>
...
<div id="table_clone" style="display: none">
	<table width="100%">
		<tr>
			<td width="50%">
				<p>Khóa học: <b class="course"></b></p>
				<p>Môn học: <b class="subject"></b></p>
			</td>
			<td width="50%">
				<p>Lớp: <b class="class"></b></p>
				<p>Ngày dạy: <b class="doc"></b></p>
			</td>
		</tr>
	</table>
...
<div id="chk_clone" style="display: none">
	<div class="d-flex justify-content-center chk-opts">
		...
		<div class="form-check form-check-inline">
		  ...
		  <label class="form-check-label absent-lbl">Vắng mặt</label>
		</div>
		<div class="form-check form-check-inline">
		  <input class="form-check-input late-inp" type="checkbox" value="2" readonly="">
		  <label class="form-check-label late-lbl">Trễ</label>
		</div>
	</div>
</div>
<style>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					  ...
					  alert_toast("Lớp đã có hồ sơ tham dự với môn học và ngày tháng đã chọn.",'danger')
					  end_load();
				}
			}
		})
