...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header"><b>Báo cáo chuyên cần</b></div>
			<div class="card-body">
				<form id="manage-attendance">
					...
					<div class="row justify-content-center">
						...
						<label for="" class="mt-2">Tháng/Năm</label>
						<div class="col-sm-3">
...
<div id="table_clone" style="display: none">
	<table width="100%">
		<tr>
			<td width="50%">
				<p>Khóa: <b class="course"></b></p>
				<p>Môn học: <b class="subject"></b></p>
				<p>Tổng số ngày của lớp học: <b class="noc"></b></p>
			</td>
			<td width="50%">
				<p>Lớp: <b class="class"></b></p>
				<p>Tháng/Năm : <b class="doc"></b></p>
			</td>
		</tr>
	</table>
