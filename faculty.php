		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="card">
					...
					<i class="fa fa-plus"></i> Thêm khoa mới
				</a></span>
					</div>
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										 <p> <b><?php echo $row['Liên hệ'] ?></b></p>
									</td>
									<td class="">
										 <p><b><?php echo  $row['Địa chỉ'] ?></b></p>
									</td>
									<td class="text-center">
										<button class="btn btn-sm btn-outline-primary edit_faculty" type="button" data-id="<?php echo $row['id'] ?>" >Sửa</button>
										<button class="btn btn-sm btn-outline-danger delete_faculty" type="button" data-id="<?php echo $row['id'] ?>">Xóa</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	$('#new_faculty').click(function(){
		uni_modal("Thêm Khoa mới","manage_faculty.php","mid-large")
	...
	$('.delete_faculty').click(function(){
		_conf("Bạn có chắc chắn muốn xóa Khoa này không?","delete_faculty",[$(this).attr('data-id')])
	})
